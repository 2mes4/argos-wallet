...
The Argos Wallet SDK is designed around a plugin architecture. You can add support for any blockchain or fiat gateway by implementing the standard interfaces.
...
1. Name your package following the convention:
   - Blockchain: `@argos-wallet/network-<name>`
   - Fiat: `@argos-wallet/regional-<name>`
   - Storage: `@argos-wallet/storage-<name>`
...
3. Add `@argos-wallet/types` as a peer dependency

4. Publish to npm with the `argos-wallet` keyword
