# Flutter SDK — `open_wallet`

Flutter package with Dart models, an HTTP API service, and Material 3 widgets for the Open Wallet SDK. Targets Flutter 3.5+ and Dart 3.5+.
