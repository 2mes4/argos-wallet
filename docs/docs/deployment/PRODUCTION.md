...
The Open Wallet SDK runs on your server. You need to expose a REST API that your frontend components can communicate with.

### Recommended Stack

- **Runtime:** Node.js >= 18
- **Framework:** Fastify or Express
- **Storage:** PostgreSQL (via `@open-wallet/storage-postgres` or custom `IStorageProvider`)
...
OW_TREASURY_ADDRESS=0xYourTreasuryAddress
