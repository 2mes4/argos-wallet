# Argos Wallet Platform — Architecture

## Overview

Argos Wallet is a **multi-tenant SaaS platform** that provides wallet infrastructure as a service. Applications register as tenants, receive an API key, and use one of the open-source SDKs (Go, TypeScript, Dart) to integrate wallet functionality into their products.
